...
<table class="responsive-table">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<!-- <button class="btn-floating waves-effect waves-light modal-trigger open-edit" data-model-id="<?php echo e($users['id']); ?>" data-target="modal1"><i class="material-icons" >edit</i></button>-->
