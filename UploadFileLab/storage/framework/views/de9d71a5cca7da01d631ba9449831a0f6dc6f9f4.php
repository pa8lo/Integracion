<nav>
  <div class="nav-wrapper grey lighten-1">
    ...
    <ul class="right hide-on-med-and-down">
      ...
      <li><a href="<?php echo e(route('adminallfiles')); ?>">Todos los archivos</a></li>
      <?php endif; ?>
      <?php elseif(Auth::guest()): ?>
      <li><a class="modal-trigger flow-text" style="font-size: 100%;" href="#login">Login
      </a></li>
      <li><a class="modal-trigger flow-text" style="font-size: 100%;" href="#registro">Registrar
      </a></li>
      <?php endif; ?>
